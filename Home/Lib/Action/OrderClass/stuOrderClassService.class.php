<?php
	class stuOrderClassService extends Action{
		...
		*/
		...
		//参数三:要查询的字段是什么
		public function getStudentOneOrderClassWithStatus($studentID = null,$classStatus = null,$field = null){
			...
			$result = $inquiry->join("inner join tp_class on tp_class.classID=tp_oneorderclass.classID and
			 tp_oneorderclass.isdelete=0 and studentID={$studentID}")->field("{$fieldString}")->select();
