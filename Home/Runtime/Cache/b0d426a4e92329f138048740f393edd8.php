                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php $i = 1; foreach ($teachers as $key => $value) {?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(($value['status']) == "1"): ?><a href="<?php echo U('Root/changeteacherinformation',array('user_id'=>$value['ID'],'status'=>'0'));?>">
                                                        <button class="btn btn-primary" style="margin:5px">禁用账号</button>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo U('Root/changeteacherinformation',array('user_id'=>$value['ID'],'status'=>'1'));?>">
                                                ...
                                                <a href="<?php echo U('Info/DeleteUser',array('user_id'=>$value['ID']));?>" class="removeAccountID"><button class="btn btn-primary"  style="margin:5px">彻底删除</button></a>
