...
<body>
 ...
 $check = md5($value['oneorderclassID']); $class_type = md5($value['classType']); ?>
                                                ...
                                                <?php if((int)$value['classStartTime']-(int)$button_effect_time<=$nowtime){?>
                                                <td><a href="<?php echo U('Student/JudgeFirstClass',array('class_id'=>$value['oneorderclassID'],'check'=>$check, 'class_type'=>$value['classType'],'class_check'=>$class_type,'teacher'=>$value['ID'],'time'=>$value['classStartTime'],'endtime'=>$value['classEndTime']));?>">
