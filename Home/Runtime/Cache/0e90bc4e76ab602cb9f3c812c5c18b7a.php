                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <!-- <li>
                            ...
                            <ul class="nav nav-second-level"> -->
                                <li>
                                    <a href="<?php echo U('Teacher/MyMouthPlan');?>"><i class="fa fa-calendar fa-fw"></i> Current Month's Schedule</a>
                                </li>
                                 <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    ...
                                    <a href="<?php echo U('Teacher/ResetPassword');?>"> Password Reset</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="<?php echo U('Teacher/TeachingMaterials');?>"><i class="fa fa-book fa-fw"></i> Teaching Material</a>
                        </li>
                        <li>
