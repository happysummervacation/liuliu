...
<body>
                  ...
                  <div class="col-lg-12">
                      <div class="panel panel-default"  style="border-radius: 0px;">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="btn-group btn-group-sm">
                                        ...
                                        <button class="btn btn-default" type="button" onclick="removeClass()">退班</button>
                                      </div>
                                    </td>
                                  </tr>
                                </tbody>
                        ...
                        <div class="panel-footer clearfix">
                          <button class="btn btn-primary pull-right"> 添加学生</button>
                        </div>
                      </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
      ...
      function removeClass(){
        ...
        if(re){
          window.location.href="<?php echo U('Group:RemoveClass');?>";
        }else{
          return;
        }
      }
