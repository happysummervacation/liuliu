                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                              <?php if(is_array($contractresult)): foreach($contractresult as $key=>$vo): if($vo[isSign] == 1){?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="2" style="text-align: center;">
                                                        <br>
                                                        <a href="<?php echo U('Contract/getContractInfo',array('isSign'=>$vo['isSign'],'orderpackageID'=>$vo['orderpackageID']));?>"><button class="btn btn-default">合同详情</button></a>
                                                    </td>
                                                </tr>
