                        ...
                        <div class="panel panel-primary">
                            ...
                            <table class="table">
                                <tbody>
                                 ...
                                 <!--这个是教师的一对一的工资-->
                                 <?php if(is_array($classResult)): foreach($classResult as $key=>$vo): ?><tr>
                                         <td><?php echo ($vo["packageName"]); ?> (Normal/Absence/Cancel)</td>
                                         <td><?php echo ($vo["haveClass"]); ?>/<?php echo ($vo["teaMissClass"]); ?>/<?php echo ($vo["teaCancelClass"]); ?></td>
                                         <td><?php echo ($vo["price"]); ?> yuan/class</td>
                                     </tr><?php endforeach; endif; ?>
                                 <?php if(is_array($commentResult)): foreach($commentResult as $key=>$vo): $classType = explode(":",$vo['commenttype'])[0]; $commentType = explode(":",$vo['commenttype'])[1]; if('0' == $classType){ ?>
                                     <tr>
                                         <?php switch($commentType): case "0": ?><td>Daily Comment</td><?php break;?>
                                             <?php case "1": ?><td>Weekly Comment</td><?php break;?>
                                             <?php case "2": ?><td>Monthly Comment</td><?php break; endswitch;?>
                                         <td><?php echo ($vo["done"]); ?>/<?php echo ($vo["all"]); ?></td>
