     ...
     <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Password Modify</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                Modify Teacher's Password
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" action="<?php echo U('Info/ChangePassword');?>" method="post">
                                  ...
                                  <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-4 control-label">New Passowrd</label>
                                    <div class="col-sm-8">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                      <input type="password" class="form-control" name="CheckNewPassword" id="CheckNewPassword">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-4">
                                        <br>
                                      <button class="btn btn-danger" type="submit" style="width:100%;">Save</button>
                                    </div>
                                  </div>
                                </form>
