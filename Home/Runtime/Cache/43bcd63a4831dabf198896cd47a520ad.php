                ...
                <div class="row" >
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel panel-primary">
                            <div class="panel-heading">顾问创建</div>
                            <div class="panel-body">
                                <form class="form-horizontal" action="<?php echo U('Info/UserManage');?>/type/add/person/admin" method="post">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                      <input name="password" type="password" class="form-control" valType="required" msg="<font color=red>*</font>密码不能为空" placeholder="密码">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-4 control-label">确认密码:</label>
                                    <div class="col-sm-8">
                                      <input name="check_password" type="password" class="form-control" valType="required" msg="<font color=red>*</font>确认密码不能为空" placeholder="验证密码">
                                    </div>
                                  </div>
                                  <div class="form-group">
