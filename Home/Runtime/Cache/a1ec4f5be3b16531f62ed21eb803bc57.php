...
<body>
	<div class="header">
		<div class="container black">
			<div class="qrcode">
				<div class="littlecode">
					<img width="16px" src="__PUBLIC__/img/little_qrcode.jpg" id="licode">
					<div class="showqrs" id="showqrs">
						<div class="shtoparrow"></div>
						<div class="guanzhuqr">
							<img src="__PUBLIC__/img/guanzhu_qrcode.png" width="80">
		...
		<div class="container">
			<div class="nav">
				<a href="https://www.alipay.com/" class="logo"><img src="__PUBLIC__/img/alipay_logo.png" height="30px"></a>
	...
	<div class="content">
		<form action="<?php echo U('Alipay/alipayapi');?>" class="alipayform" method="post" target="_blank">
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="WIDtotal_fee" readonly="true" value="<?php echo sprintf('%.2f', $packageInfo['package_money']);?>"></div>
				<br>
