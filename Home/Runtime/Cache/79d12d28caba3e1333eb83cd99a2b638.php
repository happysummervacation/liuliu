                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="col-lg-4" style="text-align: center;">
                                    <div class="well">
                                    <?php if(is_array($TeacherContract)): foreach($TeacherContract as $key=>$vo): ?><table class="table" width="400">
                                        <thead>
                                            <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="simpleline">合同编号：</td><td><?php echo ($vo["teachercontractID"]); ?></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" style="text-align: center;">
                                                        <br>
                                                        <!-- <button class="btn btn-default">Contract Details</button> -->
                                                        <button class="btn btn-default"><a href="<?php echo U('Root/DownloadTeacherContract',array('teacherContractID'=>$vo['teachercontractID']));?>">下载查看</a></button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" style="text-align: center;">
                                                        <br>
                                                        <!-- <button class="btn btn-default">Contract Details</button> -->
                                                        <button class="btn btn-default"><a href="<?php echo U('Root/DeleteContract',array('teacherContractID'=>$vo['teachercontractID']));?>">取消该合同</a></button>
                                                    </td>
                                                </tr>
                            ...
                            <div class="panel-footer" >
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">上传合同</button>
                            </div>
                        </div>
                          ...
                          <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="exampleModalLabel">上传合同</h4>
                                </div>
                                <div class="modal-body">
                                    <form enctype="multipart/form-data" action="<?php echo U('Root/UploadTeacherContract',array('user_id'=>$user_id));?>" method="post">
                                      <div class="form-group">
                                        <label for="message-text" class="control-label">上传合同(必填)(限制8M):</label>
                                        <input type="file" uploader="uploader" multiple   name="contract" value="点击添加文件"/>
                                      </div>
