...
<body>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="add">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body"  style="overflow: auto;">
                    <form class="form" method="post" action="<?php echo U('Root/addpackageforstudent');?>">
    ...
    function getpackageinformation(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo U('Root/getpackageinformation');?>",
            ...
            success:function(msg){
                if (msg=="error") {
                    ...
                    +msg['0']['category']+"</td><td>"
                    +msg['0']['package_type']+"</td><td>"
                    +msg['0']['delay_month_num']+"</td><td name='class_number'>"
                    +msg['0']['class_number']+"</td><td>"
                    +msg['0']['package_content']+"</td><td>"
                    +msg['0']['starttime']+"</td><td>"
                    +msg['0']['stoptime']+"</td><td>"
