     ...
     <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Teacher's Contracts</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <?php if(is_array($TeacherContract)): foreach($TeacherContract as $key=>$vo): ?><div class="col-lg-4" style="text-align: center;">
                                        <div class="well">
                                            <table class="table" width="400">
                                                ...
                                                <tbody>
                                                     <tr>
                                                        <td class="simpleline">Contract Number：</td><td><?php echo ($vo["teacherID"]); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" style="text-align: center;">
                                                            <br>
                                                            <!-- <button class="btn btn-default">Contract Details</button> -->
                                                            <button class="btn btn-default"><a href="<?php echo U('Contract/DownloadTeacherContract',array('teacherContractID'=>$vo['teachercontractID']));?>">下载查看</a></button>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="simpleline">Contract Status：</td>
